...
- **Gamify strategically** - Use competition, streaks, and points to drive early engagement. Transition to intrinsic motivation as users go deep.
- **People love competition** - Build competitive elements into core mechanics.

## Data & Evolution
- **Data Flywheel Hack** - Every user interaction trains your AI. Your product gets smarter daily without manual effort.
- **Data collection for app evolution** - Instrument everything from day one. Build analytics before features.
- **Truth in data and numbers** - Watch what users DO, not just what they SAY.
